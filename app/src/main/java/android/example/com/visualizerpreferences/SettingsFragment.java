...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setPreferenceSummary(final Preference preference, final String value) {
        if (preference instanceof ListPreference) {
            ...
            final int indexOfValue = listPreference.findIndexOfValue(value);
            if (indexOfValue >= 0) {
                listPreference.setSummary(listPreference.getEntries()[indexOfValue] + " is a really wonderful color.");
            }
        }
    }
