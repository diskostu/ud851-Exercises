...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        final String guestName = mNewGuestNameEditText.getText().toString();
        final String partySize = mNewPartySizeEditText.getText().toString();

        if (guestName == null || guestName.trim().isEmpty() || partySize == null || partySize.trim().isEmpty()) {
            return;
        }
        ...
        try {
            partySizeInt = Integer.parseInt(partySize);
        } catch (NumberFormatException e) {
            Log.e(LOG_TAG, "partySize is not numeric!");
            return;
        }

        // DONE (14) call addNewGuest with the guest name and party size
        final long rowIndex = addNewGuest(guestName, partySizeInt);
        Toast.makeText(this, "new rowIndex is " + rowIndex, Toast.LENGTH_SHORT).show();
        ...
        mNewGuestNameEditText.requestFocus();
    }
    ...
    private long addNewGuest(final String guestName, final int partySize) {
