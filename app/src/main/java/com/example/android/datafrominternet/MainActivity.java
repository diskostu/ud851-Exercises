...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED (6) Show this item if there is room (use app:showAsAction, not
    ...
    // COMPLETED (13) If the item's ID is R.id.action_search, show a Toast and return true to tell
    //  Android that you've handled this menu click
    // COMPLETED (14) Don't forgot to call .show() on your Toast
    // COMPLETED (15) If you do NOT handle the menu click, return super.onOptionsItemSelected to let
