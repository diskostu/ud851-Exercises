...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressBar = findViewById(R.id.pb_loading_incdicator);
    }
    ...
    private void showErrorMessage(String messageSuffix) {
        mSearchResultsTextView.setVisibility(View.INVISIBLE);

        mErrorMessageTextView.append(": " + messageSuffix);
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            if (githubSearchResults != null && githubSearchResults.startsWith("{")) {
