...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED (3) Within this method, build the URL with the text from the EditText and set the
    //  built URL to the TextView
    private void makeGitHubSearchQuery() {
        final String searchString = mSearchBoxEditText.getText().toString();
        final URL url = NetworkUtils.buildUrl(searchString);
