...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    interface ListItemClickListener {
        // COMPLETED (2) Within that interface, define a void method called onListItemClick that takes an int as a
        // parameter
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NumberViewHolder(View itemView) {
            ...
            // COMPLETED (7) Call setOnClickListener on the View passed into the constructor (use 'this' as the
            //  OnClickListener)
        ...
        // COMPLETED (6) Override onClick, passing the clicked item's position (getAdapterPosition()) to
        // mOnClickListener via its onListItemClick method
        @Override
