...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String LIFECYCLE_CALLBACKS_TEXT_KEY = "LIFECYCLE_CALLBACKS_TEXT_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our
        //  TextView
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
                final String savedString = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        final String textViewString = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, textViewString);
    }
