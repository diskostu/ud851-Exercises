...
public class MainActivity extends AppCompatActivity {
    ...
    private final static List<String> mLifecycleCallbacks = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to
        // mLifecycleDisplay
