...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private final static int GITHUB_SEARCH_LOADER = new AtomicInteger().incrementAndGet();
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            Toast.makeText(this, getString(R.string.no_input_data), Toast.LENGTH_SHORT).show();
            return;
        }

        final URL githubSearchUrl = NetworkUtils.buildUrl(githubQuery);
    ...
    public Loader<String> onCreateLoader(int i, @Nullable final Bundle bundle) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                final String searchQuery = bundle.getString(SEARCH_QUERY_URL_EXTRA);
                ...
                try {
                    return NetworkUtils.getResponseFromHttpUrl(new URL(searchQuery));
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
                }
